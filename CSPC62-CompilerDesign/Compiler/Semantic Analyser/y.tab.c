...
#define YYSTYPE char *   //for semantic values in the parser.
extern char* yytext;
...
static const yytype_uint8 yyrline[] =
{
      ...
      54,    55,    56,    57,    60,    60,    60,    60,    63,    63,
      63,    66,    66,    68,    68,    69,    72,    72,    72,    75,
      76,    79,    80,    84,    84,    84,    85,    88,    89,    89,
      92,    92,    92,    92,    96,    96,    96,    99,    99,   100,
     100,   101,   101,   102,   102,   103,   103,   104,   104,   105,
     105,   106,   106,   107,   107,   108,   108,   109,   109,   110,
     110,   111,   111,   112,   112,   113,   113,   114,   114,   115,
     115,   116,   117,   118,   119,   119,   120,   121,   126,   127,
     128,   129
};
#endif
...
insertIntoSymbolTable(char* category)
{
	...
	int i,flag;
	flag=0;
	strcpy(temp,yytext);  //yytext -> text of the current token being processed
	for(i=0;i<tableLength;i++) //search over entire table
	{
		if(!strcmp(symbolTable[i].id,temp))
			{
			flag=1;
